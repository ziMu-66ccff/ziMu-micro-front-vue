(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("zimuvue", ["vue", "wujie"], factory);
	else if(typeof exports === 'object')
		exports["zimuvue"] = factory(require("vue"), require("wujie"));
	else
		root["zimuvue"] = factory(root["vue"], root["wujie"]);
...
var ziMu = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    props: {
        width: {
            type: String,
            default: ""
    ...
    setup: function setup(props, param) {
        ...
        var init = function() {
            (0,wujie__WEBPACK_IMPORTED_MODULE_1__.startApp)({
                name: props.name,
                url: props.url,
                el: instance === null || instance === void 0 ? void 0 : instance.refs.ziMu,
...
ziMu.install = function(app) {
    app.component("zimu", ziMu);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ziMu);
